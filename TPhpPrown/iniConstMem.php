...
define ("cookDelete", -3600);    // для удаления кукиса после завершения сессии
define ("cookSession", 0);       // для задания кукиса только на время сессии
define ("cook512", 44236800);    // время жизни кукиса = 512 дней
