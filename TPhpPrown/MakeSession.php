...
/**
 * Функция установливает новое значение глобальной сессионной переменной (то
 * есть значение определенного элемента в глобальном массиве $_SESSION) и 
 * возвращает это значение наружу в вызывающий функцию модуль. Снаружи данное
 * значение записывается в локальную сессионную переменную. 
 * Стиль программирования с использованием библиотеки TPhpPrown рекомендует 
 * в коде использовать локальные сессионные переменные, предполагая неявное 
 * хранение их значений на сервере в массиве $_SESSION.
 * 
