...
// ****************************************************************************
// *           Выполнить транслитерацию [17.08.2019] строки. ВСЕГДА!!!        *
// ****************************************************************************
 ...
 * регистру.
 * 
 * Удаление дефиса в начале и конце строки. URL должен содержать дефисы только
 ...
 * 
 * Рекомендации. Предлоги, союзы, наречия и другие небольшие слова из 1-2 букв
...
function translit($s) 
{
   ...
   $s = function_exists('mb_strtolower')       // перевели строку в нижний регистр 
      ? mb_strtolower($s)   
      : strtolower($s);      
   $s = strtr($s,array                         // выполнили транслитерацию, как
   (                                           // для поисковиков Yandex и Google
      'а'=>'a',                                // (но "х" здесь всегда   
      'б'=>'b',                                // транслитируется в "h")
      'в'=>'v',   
      'г'=>'g',
      'д'=>'d',
      'е'=>'e',
